...
if (!$conn){
    ...
    $sql = "INSERT INTO `registration` ( `Username`, `Email`, `buildingname`,`Flatno`, `MobileNo`, `family members`, `Password`) VALUES ( '$Username', '$email', '$building','$flatno', '$mobileno', '$familymem', '$Password')";
