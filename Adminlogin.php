       ...
       <div class="row">
        ...
        <div class="col-2">
           <div class="form-container1">
               ...
               <img src="Images/shlogo.jpg" class="admimg" alt="">
            ...
            <div class="right box">
                ...
                <div class="content">
                    <div class="place">
                        ...
                        <span class="text">Shyamsundar Dudhbhate,Tulapur(412216)</span>
                    </div>
                    <div class="phone">
                        <span class="fas fa-phone-alt"></span>
                        <span class="text">+91 8459777100</span>
                    </div>
                    <div class="email">
                        <span class="fas fa-envelope"></span>
                        <span class="text">shyam777100@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="copyright">
            <h3>Copyright @2024|Designed with HTML,CSS,PHP.</h3>
        </div>
    </footer>
</body>
</html>-->
...
if(isset($_POST['logina'])){
    ...
    if($user=="Admin" && $adcode=="Admin@123"){
